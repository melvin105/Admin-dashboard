  ...
  return (
    <div className="mt-12"> 
      <div className="flex flex-wrap lg:flex-nowrap justify-center ">
        <div className="bg-white dark:bg-gray-800 dark:text-gray-200 h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
        ...
        <div className="flex m-3 flex-wrap justify-center gap-1 items-center">
          {earningData.map((item) => (
            <div key={item.title} className="bg-white dark:bg-gray-800 dark:text-gray-200 md:w-56 p-4 pt-9 rounded-2xl">
              <button
                type="button"
      ...
      <div className="flex gap-10 flex-wrap justify-center">
        <div className="bg-white dark:bg-gray-800 dark:text-gray-200 m-3 p-4 rounded-2xl md:w-780">
